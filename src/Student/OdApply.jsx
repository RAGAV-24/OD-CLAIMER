...
const OdApply = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-white bg-fixed [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#63e_100%)] flex items-center justify-center py-12 px-4">
