...
const Response = () => {
  return (
    <div className="min-h-screen flex items-center justify-center w-full bg-white bg-fixed [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#63e_100%)]">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-2xl">
        {/* Apply OD Header */}
        <h1 className="text-2xl font-bold mb-4 text-gray-800">Response</h1>
        <hr className="border-gray-600 w-16 mb-8" />
